...
object TestCase15 extends RtTestCase {
  ...
  val tokens_1 =
    List(
      TokIdf("nameRequest"), TokEq, TokLitStr("What is your name?"), TokEndl,
      TokIdf("print"), TokParenOpen, TokIdf("nameRequest"), TokParenClose, TokEndl,
      TokIdf("name"), TokLessMinus, TokIdf("input"), TokEndl,

      TokIdf("print"), TokParenOpen, TokLitStr("Dear "),
        TokIdf("+"), TokIdf("name"),
        TokIdf("+"), TokLitStr(", welcome!"),
      TokParenClose, TokEndl,
    )

  val expr_2 =
    exprEqAndThen("nameRequest", ExprLitStr("What is your name?"),
      exprAndThen("_", ExprCall1(ExprIdf("print"), ExprIdf("nameRequest")),
  ...
  val linted_3 =
    lintedEqAndThen("nameRequest", LintedLit("What is your name?", T_Str),
      lintedAndThen("_", lintedCalls(lintedPrint, LintedIdf("nameRequest", T_Str)),
